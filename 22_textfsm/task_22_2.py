...
f = open('/opt/myallgit/online-7-eugene-zayka/exercises/22_textfsm/output/sh_ip_dhcp_snooping.txt')
file = f.read()
pprint(parse_command_output('/opt/myallgit/online-7-eugene-zayka/exercises/22_textfsm/templates/sh_ip_dhcp_snooping.template', file))
