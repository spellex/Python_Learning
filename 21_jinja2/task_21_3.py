...
Проверьте получившийся шаблон templates/ospf.txt, на данных
в файле data_files/ospf.yml,
...
router_2 = yaml.load(open('/opt/myallgit/online-7-eugene-zayka/exercises/21_jinja2/data_files/ospf.yml'))
print(generate_config('templates/ospf.txt', router_2))
