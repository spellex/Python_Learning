...
if __name__ == '__main__':
    router_1 = yaml.load(open('/opt/myallgit/online-7-eugene-zayka/exercises/21_jinja2/data_files/router_info.yml'))
    print(generate_config('templates/cisco_router_base.txt', router_1))
